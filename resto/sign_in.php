...
<main class="form-signin w-50 m-auto">
  <form action="" method="post">
    ...
    <div class="form-floating">
      <input type="text" name="user_username" class="form-control" id="floatingInput" placeholder="name@example.com">
    ...
    <button class="w-100 btn btn-lg btn-danger" type="submit" name="user_login">Sign in</button>
    
  </form>
  <p class="small text-center text-gray-soft">Don't have an account yet? <a href="sign_up.php">Sign up</a></p>
</main>
</div> 
<br><br>
...
<?php
 if (isset($_POST['user_login'])){
  ...
  if($row_count>0){
    ...
    $rowtest=$row_data['user_password'];
    $role=$row_data['role'];
    if($user_password==$rowtest){
      if($role=='admin'){
        echo "<script> alert('welcome Admin')</script>";
        echo "<script> window.open('./admin_area/index.php','_self')</script>";
      }else if($row_count==1 and $row_count_cart==0){
