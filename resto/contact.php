...
.gradient-background {
    background: linear-gradient(300deg, #b95716, #380909, #d81616);
    background-size: 180% 180%;
    animation: gradient-animation 18s ease infinite;
  }
  .gradient-background1 {
    background: linear-gradient(300deg, #ffffff, #faa1a1, #ffc0cb);
    background-size: 180% 180%;
    animation: gradient-animation 18s ease infinite;
  }
  ...
  <header class="py-5 gradient-background">
    <div class="container px-4 px-lg-5 my-5">
      <div class="text-center text-white">
        ...
        <p class="lead fw-normal text-white-50 mb-0">Let us know how can we help! </p>
      </div>
    </div>
  </header>
  <br><br>
