     ...
     <header class="py-5 gradient-background">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Make an account</h1>
                <p class="lead fw-normal text-white-50 mb-0">Join Us! </p>
            </div>
        </div>
    </header>
...
<main class="form-signin w-50 m-auto">
  <form action="" method="post" >
    <img class="mb-4" src="assets/felfel.png" alt="" width="72" height="57">
    ...
    <div class="form-floating">
      <input type="tel" name="phone" class="form-control" id="number" placeholder="PhoneNumber" required>
    ...
    <div class="form-floating">
      <input type="password" name="repeat-password" class="form-control" id="repeatpass" placeholder="Repeat Password" required>
      <label for="floatingPassword">Repeat Password</label>
    </div><br>

    <button class="w-100 btn btn-lg btn-danger" type="submit" name="user_register">Sign Up</button>
...
<br><br>
    <script>
      // Get references to the password and repeat password inputs
var passwordInput = document.getElementById('pass');
var repeatPasswordInput = document.getElementById('repeatpass');

// Add an event listener to the repeat password input
repeatPasswordInput.addEventListener('input', function() {
  ...
  if (password !== repeatPassword) {
    // Set the border color to red if they don't match
    repeatPasswordInput.style.borderColor = 'red';
  } else {
    // Reset the border color if they match
...
if(isset($_POST['user_register'])){
  ...
  $conf_user_password=$_POST['repeat-password'];
...
if($rows_count>0){
  echo "<script> alert('Username already in use, Try to log in');</script>";
}else if($user_password!=$conf_user_password){
  echo "<script> alert('Passwords does not match, Try again please!')</script>";}
else{

// insert_query

$insert_query="INSERT into user_table (username,user_email,user_password,user_mobile,ip_add,role) values('$user_username','$user_email',' $user_password','$user_phone','$ip','user') ";
