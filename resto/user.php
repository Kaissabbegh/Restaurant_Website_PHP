...
<script>
  ...
  <div class="row ">
    <div class="col-md-12 p-5 d-flex align-items-center gradient-background">
      <?php
      ...
      if($user_img==''){
        echo"<a><img src='assets/person-circle.svg' width='100'></a>";
      }
      else{
        echo"<a><img src='./user_img/$user_img' width='100'></a>";
      }
      ?>
      <!-- <a href="./user.php?change_pic"><img src="assets/person-circle.svg" width="100"></a> -->
     
      <p class="text-light text-center px-5"><?php
                if(isset($_SESSION['username'])){
                    echo $_SESSION['username'];
                }
                ?></p> 

      <div class="col-md-6 mx-auto d-flex align-items-center text-center" >
        <button><a href="user.php?my_orders" class="nav-link text-dark  my-1">My Orders</a></button>
        <button><a href="user.php?delete_account" class="nav-link text-dark  my-1">Delete Account</a></button>
        <button><a href="logout.php" class="nav-link text-dark  my-1">Logout</a></button>
